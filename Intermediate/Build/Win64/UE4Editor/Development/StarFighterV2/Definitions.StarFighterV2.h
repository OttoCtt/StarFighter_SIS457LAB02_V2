...
#define UE_PROJECT_NAME StarFighterV2
#define UE_TARGET_NAME StarFighterV2Editor
#define UE_MODULE_NAME "StarFighterV2"
...
#define STARFIGHTERV2_API DLLEXPORT
